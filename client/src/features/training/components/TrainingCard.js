...
export default function TrainingCard(props) {
    ...
    React.useEffect(() => {
        ...
        if (upcomingTrainingSuccess) {
            setSorting({ columnToSort: 'training.completedOn', sortDirection: 'asc' })
        }
            ...
            <Box p={2}>
                ...
                <Collapse in={expanded} unmountOnExit>
                    <Grid container spacing={2} paddingBottom={2}>
                        ...
                        <Grid item>
                            {!fetchedTrainingError && <ResetButton handleReset={() => handleReset()} />}
                        </Grid>
                    </Grid>
                    {upcomingTrainingSuccess ?
                        ...
                        "Error fetching upcoming training. Please try again later." :
