import { Select, MenuItem, FormControlLabel, Checkbox, TextField, Grid, InputLabel, FormControl, InputAdornment, Typography, Divider } from '@mui/material'
...
export function ViewProfileDetails(props) {
    ...
    if (props.volunteer && fetchedAwards && fetchedDocuments && props.upcomingAwards) {
        return (
