...
import { useGetRolesQuery, useGetVolunteersQuery } from "../../../features/api/apiSlice";
...
export function VolunteerContainer(props) {
    ...
    if (volunteerError || roleError) {
        return <div>Error! Could not fetch volunteers.</div>
    }
                            ...
                            <Grid container justifyContent={'center'}>
                                <Grid item xs={12} md={10} lg={8}>
                                    <Box sx={{ textAlign: 'center', p: 2 }}>
                                        ...
                                        <br /> <br />
                                        <Button variant="outlined" onClick={() => navigate("/dashboard/create-volunteer")}>
                                            Create Volunteer
                                        </Button>
                                    </Box>
                                </Grid>
